...
4. Create one or more trigger zones covering the entire race track, allowing to detect if   
   participants entered or left the race track.   Usually, one large zone is enough, but  
   if you want finer control over a long, thin track, you may place multiple zones to  
   cover the entire race track area. Name them "racezone-1", "racezone-2", ...  and so on.  
   Don't use leading zeroes for the numbers.  
